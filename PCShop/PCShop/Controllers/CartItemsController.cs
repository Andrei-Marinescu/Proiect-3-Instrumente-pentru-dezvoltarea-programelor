...
namespace PCShop.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public CartItemsController(PCShopContext context)
        {
            _context = context;
        }
        ...
        {
            var pCShopContext = _context.CartItems.Include(c => c.Cart).Include(c => c.Product);
        ...
        public async Task<IActionResult> Create([Bind("CartItemId,Quantity,Price,CartId,ProductId")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartItemId,Quantity,Price,CartId,ProductId")] CartItem cartItem)
        {
